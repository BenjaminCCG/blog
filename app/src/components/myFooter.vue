<!-- 底部公用 -->
<template>
    <div  class="footBack footBackHui">
        ...
        <div class="fcontainer">
            ...
            <p>
                © 2020 <a href="#">BenjaminBlog</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. 皖ICP备20002032号-1.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="@/assets/image/heart02.png"/>  <span>by Benjamin.</span>
            </p>
        </div>
    </div>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2020/11/25 00:00:00');
